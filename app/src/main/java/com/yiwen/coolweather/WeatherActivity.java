...
import com.yiwen.coolweather.service.AutoUpdateService;
...
public class WeatherActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Log.d("WeatherActivity", "onCreate: " + bingPic);
        if (bingPic != null) {
        ...
        HttpUtil.sendOkhttpReques(url, new Callback() {
            ...
            public void onResponse(Call call, Response response) throws IOException {
                ...
                runOnUiThread(new Runnable() {
                    @Override
                    public void run() {
                        Log.d("WeatherActivity", "run: " + (weather != null));
    ...
    private void initViews() {
        ...
        swipeRefesh = (SwipeRefreshLayout) findViewById(R.id.swipe_refrash);
